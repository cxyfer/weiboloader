...
Define the filesystem timestamp contract for downloaded media files and metadata sidecars so artifact `mtime` matches the normalized post timestamp used by filename rendering.
